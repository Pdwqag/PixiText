...
app.config.update(
    ...
    SYNC_UPLOADS_URL=os.getenv("SYNC_UPLOADS_URL", ""),
    SYNC_SAVES_URL=os.getenv("SYNC_SAVES_URL", ""),
...
def inject_cloud_links():
    ...
    mega = _provider(
        "mega",
        "MEGA",
        app.config.get("MEGA_UPLOADS_URL"),
        app.config.get("MEGA_SAVES_URL"),
    )
    sync = _provider(
        "sync",
        "Sync.com",
